...
Seluruh foto di `src/assets/` saat ini adalah **stok sementara berlisensi bebas**
dari Wikimedia Commons — pengganti placeholder hijau, sampai foto asli dari mitra
masuk (deadline 30 Juli 2026, PLANNING.md §8). Saat menimpa dengan foto asli,
hapus baris terkait di tabel ini.

> **Kewajiban lisensi:** foto CC BY / CC BY-SA mewajibkan atribusi. Selama foto
> ini masih dipakai di produksi, tautkan halaman ini (atau salin daftar di bawah)
> dari situs, mis. di halaman kredit/footer. Foto CC0/Public Domain tidak wajib
> atribusi, tetapi tetap dicatat demi keterlacakan.
...
Semua file di-crop & di-resize (maks. 1600 px, JPEG q82) lalu dikonversi otomatis
ke WebP oleh pipeline `astro:assets` saat build.
